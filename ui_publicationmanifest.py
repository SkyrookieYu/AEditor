...
class Ui_PublicationManifest(object):
    def setupUi(self, PublicationManifest):
        ...
        PublicationManifest.resize(572, 864)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 558, 850))
        ...
        self.dateTimeEdit_dateModified.setReadOnly(True)
        ...
        self.dateEdit_datePublished = QtWidgets.QDateEdit(self.scrollAreaWidgetContents_2)
        self.dateEdit_datePublished.setCurrentSectionIndex(0)
        self.dateEdit_datePublished.setTimeSpec(QtCore.Qt.LocalTime)
        self.dateEdit_datePublished.setObjectName("dateEdit_datePublished")
        self.formLayout_3.setWidget(21, QtWidgets.QFormLayout.LabelRole, self.dateEdit_datePublished)
        ...
        self.comboBox_inLanguage = QtWidgets.QComboBox(self.scrollAreaWidgetContents_2)
        self.comboBox_inLanguage.setCurrentText("zh-TW")
        self.comboBox_inLanguage.setObjectName("comboBox_inLanguage")
        ...
        self.comboBox_inLanguage.addItem("")
        self.comboBox_inLanguage.addItem("")
        self.formLayout_3.setWidget(25, QtWidgets.QFormLayout.SpanningRole, self.comboBox_inLanguage)
        ...
        self.comboBox_readingProgression = QtWidgets.QComboBox(self.scrollAreaWidgetContents_2)
        self.comboBox_readingProgression.setObjectName("comboBox_readingProgression")
        self.comboBox_readingProgression.addItem("")
        self.comboBox_readingProgression.addItem("")
        self.formLayout_3.setWidget(29, QtWidgets.QFormLayout.SpanningRole, self.comboBox_readingProgression)
        ...
        self.comboBox_inLanguage.setCurrentIndex(36)
    ...
    def retranslateUi(self, PublicationManifest):
        ...
        self.dateTimeEdit_dateModified.setDisplayFormat(_translate("PublicationManifest", "yyyy-MM-ddThh:mm:ssZ"))
        self.label_datePublished.setText(_translate("PublicationManifest", "datePublished"))
        self.dateEdit_datePublished.setDisplayFormat(_translate("PublicationManifest", "yyyy-MM-dd"))
        ...
        self.comboBox_inLanguage.setItemText(0, _translate("PublicationManifest", "ar-SA"))
        self.comboBox_inLanguage.setItemText(1, _translate("PublicationManifest", "cs-CZ"))
        self.comboBox_inLanguage.setItemText(2, _translate("PublicationManifest", "da-DK"))
        self.comboBox_inLanguage.setItemText(3, _translate("PublicationManifest", "de-DE"))
        self.comboBox_inLanguage.setItemText(4, _translate("PublicationManifest", "el-GR"))
        self.comboBox_inLanguage.setItemText(5, _translate("PublicationManifest", "en-AU"))
        self.comboBox_inLanguage.setItemText(6, _translate("PublicationManifest", "en-GB"))
        self.comboBox_inLanguage.setItemText(7, _translate("PublicationManifest", "en-IE"))
        self.comboBox_inLanguage.setItemText(8, _translate("PublicationManifest", "en-US"))
        self.comboBox_inLanguage.setItemText(9, _translate("PublicationManifest", "en-ZA"))
        self.comboBox_inLanguage.setItemText(10, _translate("PublicationManifest", "es-ES"))
        self.comboBox_inLanguage.setItemText(11, _translate("PublicationManifest", "es-MX"))
        self.comboBox_inLanguage.setItemText(12, _translate("PublicationManifest", "fi-FI"))
        self.comboBox_inLanguage.setItemText(13, _translate("PublicationManifest", "fr-CA"))
        self.comboBox_inLanguage.setItemText(14, _translate("PublicationManifest", "fr-FR"))
        self.comboBox_inLanguage.setItemText(15, _translate("PublicationManifest", "he-IL"))
        self.comboBox_inLanguage.setItemText(16, _translate("PublicationManifest", "hi-IN"))
        self.comboBox_inLanguage.setItemText(17, _translate("PublicationManifest", "hu-HU"))
        self.comboBox_inLanguage.setItemText(18, _translate("PublicationManifest", "id-ID"))
        self.comboBox_inLanguage.setItemText(19, _translate("PublicationManifest", "it-IT"))
        self.comboBox_inLanguage.setItemText(20, _translate("PublicationManifest", "ja-JP"))
        self.comboBox_inLanguage.setItemText(21, _translate("PublicationManifest", "ko-KR"))
        self.comboBox_inLanguage.setItemText(22, _translate("PublicationManifest", "nl-BE"))
        self.comboBox_inLanguage.setItemText(23, _translate("PublicationManifest", "nl-NL"))
        self.comboBox_inLanguage.setItemText(24, _translate("PublicationManifest", "no-NO"))
        self.comboBox_inLanguage.setItemText(25, _translate("PublicationManifest", "pl-PL"))
        self.comboBox_inLanguage.setItemText(26, _translate("PublicationManifest", "pt-BR"))
        self.comboBox_inLanguage.setItemText(27, _translate("PublicationManifest", "pt-PT"))
        self.comboBox_inLanguage.setItemText(28, _translate("PublicationManifest", "ro-RO"))
        self.comboBox_inLanguage.setItemText(29, _translate("PublicationManifest", "ru-RU"))
        self.comboBox_inLanguage.setItemText(30, _translate("PublicationManifest", "sk-SK"))
        self.comboBox_inLanguage.setItemText(31, _translate("PublicationManifest", "sv-SE"))
        self.comboBox_inLanguage.setItemText(32, _translate("PublicationManifest", "th-TH"))
        self.comboBox_inLanguage.setItemText(33, _translate("PublicationManifest", "tr-TR"))
        self.comboBox_inLanguage.setItemText(34, _translate("PublicationManifest", "zh-CN"))
        self.comboBox_inLanguage.setItemText(35, _translate("PublicationManifest", "zh-HK"))
        self.comboBox_inLanguage.setItemText(36, _translate("PublicationManifest", "zh-TW"))
        ...
        self.comboBox_readingProgression.setItemText(0, _translate("PublicationManifest", "ltr"))
        self.comboBox_readingProgression.setItemText(1, _translate("PublicationManifest", "rtl"))
        self.label_type.setText(_translate("PublicationManifest", "type"))
        self.lineEdit_type.setText(_translate("PublicationManifest", "Audiobook"))

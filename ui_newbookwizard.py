...
class Ui_NewBookWizard(object):
    def setupUi(self, NewBookWizard):
        ...
        self.widget = QtWidgets.QWidget(NewBookWizard)
        self.widget.setGeometry(QtCore.QRect(240, 440, 134, 27))
    ...
    def retranslateUi(self, NewBookWizard):
        ...
        self.label_FilePath.setText(_translate("NewBookWizard", "File path:"))
